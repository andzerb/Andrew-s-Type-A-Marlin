...
#define STRING_CONFIG_H_AUTHOR "(Andrew's printer, Type A Machines, Series 1 Beta, 2014)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,275}  // default steps per unit for 2014 Series 1 (2GT belt Beta1)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 12.5, 160}    // (mm/sec)
